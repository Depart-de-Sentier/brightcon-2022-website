  ...
  <div class="container">
    <div class="card">
      ...
      <h4>
        ...
        <a href="https://www.circulartree.com/">CircularTree</a> to the
        <a
          target="_blank"
          href="https://github.com/orgs/LCA-ActivityBrowser/people"
        >
          <i>Activity Browser team</i></a
        >
      </h4>
      for their contribution to brightway.
      <a href="https://github.com/marc-vdm" target="_blank"
        >Mark van der Meide</a
      >
      was present during the conference receiveing the award from the hands of
      <a href="https://www.linkedin.com/in/kathrin-adam/" target="_blank"
        >Katrhina Adam</a
      >, on behalf of the whole team.
      <a href="https://github.com/bsteubing" target="_blank"
        >Bernhard Steubing
      </a>
      ...
      <h4>
        ...
        <a href="https://iedl.no/#Team" target="_blank"
          ><i>NTNU Industrial Ecology Digital Laboratory</i></a
        >
      </h4>
      ...
      <a href="https://www.linkedin.com/in/david-fitzgerald-589a9078/"
        >David Fitzgerald
      </a>
      presented the award to
      <a href="https://github.com/konstantinstadler/" target="_blank"
        >Konstantin Stadler</a
      >
      ...
      open database <a href="https://www.exiobase.eu/">EXIOBASE</a>. The mission
      ...
      <a href="https://github.com/romainsacchi" target="_blank">Romain</a> is
      involved not only in
      <a href="https://github.com/polca/premise" target="_blank">premise</a>,
      ...
      <a
        href="https://www.linkedin.com/in/martin-julien-20a7427a/"
        target="_blank"
        >Julien Martin</a
      >
      and
      <a
        href="https://www.linkedin.com/in/achille-laurent-84abb915/"
        target="_blank"
        >Achille Laurent</a
      >
      ...
      <h4>
        ...
        <a href="https://www.rte-france.com/" target="_blank">RTE</a>
        <a
          href="https://www.linkedin.com/in/benjamin-w-portner/"
          target="_blank"
          >Benjamin Portner</a
        >
      </h4>
      ...
      <a href="https://www.linkedin.com/in/guillaume-busato-31138358/"
        >Guillaume Busato</a
      >. Rte is an energy operator in France, hence key player in transition
